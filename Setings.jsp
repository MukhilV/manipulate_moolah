  ...
  <div class="card" >
    ...
    <div class="card-body" style="font-size:15px;">
    		<h3 style="text-align:center "> Warning!. Once the account is deleted, it cannot be undone</h3>
    		 ...
    		 <input type="password" name="delpassword" id="delpassword" style="height: 70px; width: 100%" placeholder=" Confirm your password to delete the account">
...
if(delaccstatus!=null){
	out.println("<div class=\"alert alert-dark\"><strong>"+delaccstatus+"</strong></div>");
}
%>
</div>
